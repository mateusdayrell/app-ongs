...
export default function Detail () {
    ...
    const message = `Ola ${incident.name}, gostaria de ajudar no caso "${incident.title}" com o valor de ${Intl.NumberFormat('pt-Br', { style: 'currency',  currency: 'BRl' }).format(incident.value)}`
